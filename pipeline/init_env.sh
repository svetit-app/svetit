...
PASS_KEYS="DB_PASS SSO_DB_PASS SSO_ADMIN_PASS AUTH_DB_PASS APP_DB_PASS OIDC_CLIENT_SECRET SPACE_DB_PASS PROJECT_DB_PASS NODE_DB_PASS DTLSGATEWAY_DB_PASS"
