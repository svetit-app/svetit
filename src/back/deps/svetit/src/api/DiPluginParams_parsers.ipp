...
static constexpr USERVER_NAMESPACE::utils::TrivialSet
    ksvetit__api__DiPluginParams_PropertiesNames = [](auto selector) {
      return selector().template Type<std::string_view>().Case("list").Case(
          "total");
    };

template <typename Value>
svetit::api::DiPluginParams Parse(
    Value value,
  ...
  res.list =
      value["list"]
          .template As<USERVER_NAMESPACE::chaotic::Array<
              USERVER_NAMESPACE::chaotic::Primitive<svetit::api::DiPluginParam>,
              std::vector<svetit::api::DiPluginParam>,
              USERVER_NAMESPACE::chaotic::MaxItems<100>>>();
  res.total =
      value["total"]
          .template As<USERVER_NAMESPACE::chaotic::Primitive<
              std::int64_t, USERVER_NAMESPACE::chaotic::Minimum<
                                svetit::api::DiPluginParams::kTotalMinimum>>>();
