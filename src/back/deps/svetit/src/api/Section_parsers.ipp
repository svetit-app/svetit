...
static constexpr USERVER_NAMESPACE::utils::TrivialSet
    ksvetit__api__Section_PropertiesNames = [](auto selector) {
      return selector()
...
svetit::api::Section Parse(
    Value value, USERVER_NAMESPACE::formats::parse::To<svetit::api::Section>) {
