...
template<typename T, const std::string_view* handlerName, const std::string_view* idKey = kIdKey>
...
template<typename T, const std::string_view* handlerName, const std::string_view* idKey>
inline SimpleCrud2<T, handlerName, idKey>::SimpleCrud2(
	const components::ComponentConfig& conf,
	const components::ComponentContext& ctx)
...
template<typename T, const std::string_view* handlerName, const std::string_view* idKey>
inline formats::json::Value SimpleCrud2<T, handlerName, idKey>::HandleRequestJsonThrow(
	const server::http::HttpRequest& req,
	const formats::json::Value& body,
...
template<typename T, const std::string_view* handlerName, const std::string_view* idKey>
inline formats::json::Value SimpleCrud2<T, handlerName, idKey>::Get(Table* table, const formats::json::Value& params, const boost::uuids::uuid& spaceId) const
{
...
template<typename T, const std::string_view* handlerName, const std::string_view* idKey>
inline formats::json::Value SimpleCrud2<T, handlerName, idKey>::Post(
	Table* table,
	const server::http::HttpRequest& req,
	const boost::uuids::uuid& spaceId,
	const formats::json::Value& body) const
...
template<typename T, const std::string_view* handlerName, const std::string_view* idKey>
inline void SimpleCrud2<T, handlerName, idKey>::Patch(
	Table* table,
	const server::http::HttpRequest& req,
	const boost::uuids::uuid& spaceId,
	const formats::json::Value& body) const
...
template<typename T, const std::string_view* handlerName, const std::string_view* idKey>
inline void SimpleCrud2<T, handlerName, idKey>::Delete(Table* table, const formats::json::Value& params, const boost::uuids::uuid& spaceId, const server::http::HttpRequest& req) const
{
...
template<typename T, const std::string_view* handlerName, const std::string_view* idKey>
template<typename Id2Type>
Id2Type SimpleCrud2<T, handlerName, idKey>::getId2(const formats::json::Value& params) const
{
