...
(6, NULL, 'paramType6', 'Param Type 6', 'Description of Param Type 6', 'int', TRUE);
...
(2, '11111111-1111-1111-1111-111111111111', 'Section 2', TRUE);
...
(2, '11111111-1111-1111-1111-111111111111', 'ccType2', 'CC Type 2', 'Description of CC Type 2', TRUE);
...
(2, '11111111-1111-1111-1111-111111111111', 'Plugin 2', 'Description of Plugin 2', 'plugin_2', TRUE);
...
(2, '11111111-1111-1111-1111-111111111111', 1, 'Device 2', 1000, TRUE);
...
(2, '11111111-1111-1111-1111-111111111111', 'M2', TRUE);
...
(2, 1, 1, 'diType2', 'DI Type 2', 'readonlyFlag', 'off', TRUE);
...
(2, 1, 'ccModeType2', 'CC Mode Type 2', TRUE);
...
(2, '11111111-1111-1111-1111-111111111111', 'ccStatusCategory2', 'CC Status Category 2', 'black', TRUE);
...
(2, 1, 1, 'ccStatusType2', 'CC Status Type 2', FALSE, TRUE);
